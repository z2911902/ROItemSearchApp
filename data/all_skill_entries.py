...
all_skill_entries = {#範例[    "": {"buff":"","type": "技能/料理","code":["",""]},    
    ...
    #妖術
    "魔力拳": {"buff":"432","id": "SO","type": "技能","code":["UseSkill(2445)","if GUSklv(2456) == 0 then","temp1 = GetSkillLevel(19)","temp = GetSkillLevel(14)","temp2 = GetSkillLevel(20)","temp2445 = GetSkillLevel(2445)","AddDamage_passive_SKID(1, 19, -100+(100*temp1)+(20*temp2445))","AddDamage_passive_SKID(1, 14, -100+(100*temp)+(20*temp2445))","AddDamage_passive_SKID(1, 20, -100+(100*temp2)+(20*temp2445))","end"]},
    "精靈控制Lv.1": {"buff":"","id": "SO","type": "技能","code":["UseSkill(2456)","temp2445 = 0","if GUSklv(2445) == 1 then","temp2445 = GetSkillLevel(2445)","end","if GUSklv(5375) == 1 then","temp1 = GetSkillLevel(19)","AddDamage_passive_SKID(1, 19, -100+(100*temp1)+(20*temp2445))","end","if GUSklv(5376) == 1 then","temp = GetSkillLevel(14)","AddDamage_passive_SKID(1, 14, -100+(100*temp)+(20*temp2445))","end","if GUSklv(5377) == 1 then","temp2 = GetSkillLevel(20)","AddDamage_passive_SKID(1, 20, -100+(100*temp2)+(20*temp2445))","end"]},
