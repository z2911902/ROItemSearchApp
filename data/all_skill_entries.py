...
all_skill_entries = {#範例[    "": {"buff":"","type": "技能/料理","code":["",""]},    
    ...
    "精靈控制Lv.1": {"buff":"","id": "SO","type": "技能","code":["UseSkill(2456)","if GUSklv(5375) == 1 or GUSklv(5376) == 1 or GUSklv(5377) == 1 then","temp_4ht = 1","end","if GUSklv(2445) == 0 and temp_4ht == 1 then","temp = GetSkillLevel(14)","temp1 = GetSkillLevel(19)","temp2 = GetSkillLevel(20)","AddDamage_passive_SKID(1, 14, -100+(100*temp))","AddDamage_passive_SKID(1, 19, -100+(100*temp1))","AddDamage_passive_SKID(1, 20, -100+(100*temp2))","end"]},
